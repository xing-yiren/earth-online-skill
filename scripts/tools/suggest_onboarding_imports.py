"""Structured tool entrypoint for suggest_onboarding_imports."""
...
from scripts.renderers import render_suggest_onboarding_imports


def run(payload: dict) -> dict:
    result = OnboardingImportService().suggest_candidates(payload)
